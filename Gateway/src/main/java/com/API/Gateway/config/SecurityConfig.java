...
//
//    @Bean
//    public SecurityWebFilterChain securityFilterChain(ServerHttpSecurity serverHttpSecurity) throws NoSuchAlgorithmException {
//        ServerHttpSecurity serverHttpSecurity1 = serverHttpSecurity.csrf(csrfSpec -> csrfSpec.disable())
//                .authorizeExchange(authorizeExchangeSpec -> authorizeExchangeSpec.pathMatchers("/eureka/*").permitAll()
//                        .anyExchange().authenticated())
//                .oauth2ResourceServer(oAuth2ResourceServerSpec -> jwtDecoder());
